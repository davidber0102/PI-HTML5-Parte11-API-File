...
function modificar() {
    ...
    origen=ruta+origen;
    espacio.getDirectory(origen, null, function(archivi){
    //espacio.getFile(origen, null, function(archivi){ // elimna archivos
            archivi=remove(exito,errores);
     }, errores);
}
...
/* function modificar() {
    ...
    espacio.getFile(origen, null, function(archivi){
        espacio.getDirectory(destino, null, function(directorio){
            archivi.moveTo(directorio, null, exito, errores);
        }, errores);
    }, errores);
} */
